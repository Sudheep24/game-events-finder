        ...
        <div className="p-16">
            <Form {...form} >
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-5 md:flex-row">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    <FormControl>
                                        <input type="number" name="availableslots" className="rounded-full p-2 bg-black border border-slate-500" placeholder="Available slots" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    <FormControl>
                                        <input type="number" name="Entry Fee" className="rounded-full p-2 bg-black border border-slate-500" placeholder="Entry Fee" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    <FormControl>
                                        <input type="number" name="Event Time" className="rounded-full p-2 bg-black border border-slate-500" placeholder="Event Time" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    {/* Add other FormFields for remaining data fields */}
